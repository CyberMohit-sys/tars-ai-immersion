    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-xl mt-4 text-foreground">Create Account</h1>
          <p className="text-muted-foreground text-sm mt-1">Join the autonomous intelligence platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-sm text-muted-foreground font-display block mb-1.5">Name</label>
            <input type="text" value={name} onChange={e => setName(e.target.value)}
              className="w-full bg-muted/30 border border-border/40 rounded-xl px-4 py-3 text-foreground text-sm focus:outline-none focus:border-primary/50 transition-colors" placeholder="Your name" />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="password" required value={password} onChange={e => setPassword(e.target.value)}
              className="w-full bg-muted/30 border border-border/40 rounded-xl px-4 py-3 text-foreground text-sm focus:outline-none focus:border-primary/50 transition-colors" placeholder="Min. 6 characters" />
          </div>
          <button type="submit" className="btn-glow text-primary-foreground w-full py-3 mt-2">Create Account</button>
        </form>
